          ...
          <div className="work-grid">
            ...
            <div className="glass-panel project-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '25px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, flex: 1 }}>{t.work.projects.p1.desc}</p>
            ...
            <div className="glass-panel project-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '25px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, flex: 1 }}>{t.work.projects.p2.desc}</p>
                <a href="https://hamrosabzi.vercel.app/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '20px', fontSize: '0.95rem', transition: 'color 0.3s' }} onMouseOver={e => e.currentTarget.style.color = 'var(--accent)'} onMouseOut={e => e.currentTarget.style.color = 'var(--text-primary)'}>{t.work.btnViewMobileApp} <span style={{ color: 'var(--accent)' }}>↗</span></a>
              </div>
            </div>
            ...
            <div className="glass-panel project-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '25px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, flex: 1 }}>{t.work.projects.p3.desc}</p>
                <a href="https://msilverlight.com.np/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '20px', fontSize: '0.95rem', transition: 'color 0.3s' }} onMouseOver={e => e.currentTarget.style.color = 'var(--accent)'} onMouseOut={e => e.currentTarget.style.color = 'var(--text-primary)'}>{t.work.btnVisitSite} <span style={{ color: 'var(--accent)' }}>↗</span></a>
              </div>
            </div>
            ...
            <div className="glass-panel project-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '25px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, flex: 1 }}>{t.work.projects.p4.desc}</p>
                <a href="https://shreekrishna.jyasapasa.workers.dev/login" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '20px', fontSize: '0.95rem', transition: 'color 0.3s' }} onMouseOver={e => e.currentTarget.style.color = 'var(--accent)'} onMouseOut={e => e.currentTarget.style.color = 'var(--text-primary)'}>{t.work.btnViewApp} <span style={{ color: 'var(--accent)' }}>↗</span></a>
              </div>
            </div>
            ...
            <div className="glass-panel project-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '25px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, flex: 1 }}>{t.work.projects.p5.desc}</p>
            ...
            <div className="glass-panel project-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ padding: '25px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <a href="https://khataplus.pages.dev" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '20px', fontSize: '0.95rem', transition: 'color 0.3s' }} onMouseOver={e => e.currentTarget.style.color = 'var(--accent)'} onMouseOut={e => e.currentTarget.style.color = 'var(--text-primary)'}>{t.work.btnViewApp} <span style={{ color: 'var(--accent)' }}>↗</span></a>
              </div>
            </div>
